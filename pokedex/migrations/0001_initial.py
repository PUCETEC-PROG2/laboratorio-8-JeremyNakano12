    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('region', models.CharField(choices=[('K', 'Kanto'), ('S', 'Sinnoh'), ('KA', 'Kalos'), ('T', 'Teselia'), ('A', 'Alola'), ('H', 'Hoenn')], max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('E', 'Electric'), ('GR', 'Ground'), ('R', 'Rock'), ('W', 'Water'), ('G', 'Grass'), ('I', 'Ice'), ('N', 'Normal'), ('F', 'Fire')], max_length=15)),
